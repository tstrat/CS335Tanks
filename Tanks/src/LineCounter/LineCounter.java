 ...
 * 
 * LineCounter is pretty freaking awesome.
 * 
 * @author Seungwoo Sun
 * 
 */
public class LineCounter {
	 ...
	 *            scanner when you already have one.
	 * @return Whether the user said they wanted to repeat or not.
	 */
	private static boolean repeatMainBody(Scanner keyScan) {
		System.out
